...
//if( file_exists('timthumb-config.php')) 	get_template_part('timthumb','config'); 
...
if(! defined('FILE_CACHE_SUFFIX') ) 		define ('FILE_CACHE_SUFFIX', '.imgcached.txt');		// What to put at the end of all files in the cache directory so we can identify them
